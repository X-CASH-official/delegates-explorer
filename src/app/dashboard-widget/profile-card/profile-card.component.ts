...
Swal.fire({
  ...
  width: this.width,
  customClass: 'swal-height',
  html: 'Once the wallet is loaded, type the following command:<br><br>delegate_update ITEM (about, website, team, shared_delegate_status, delegate_fee and server_specs)',
  showCloseButton: false,
  showCancelButton: false,
})
    }
...
Swal.fire({
  ...
  width: this.width,
  customClass: 'swal-height',
  html: 'Get a list of all delegates<br><br>Method: GET<br><br>URL: /getdelegates<br><br>Result:<br><br>total_vote_count: The total amount staked towards the delegate<br><br>delegate_name: The delegates name<br><br>shared_delegate_status: True if this is a delegate that wants users to vote for them, false is this delegate does not want users to vote for them<br><br>delegate_fee: The fee in a percent<br><br>block_verifier_score: How many invalid reserve proofs the delegate has found<br><br>online_status: The current online status of the delegate<br><br>block_verifier_total_rounds: The total rounds the delegate has been a block verifiers<br><br>block_verifier_online_percentage: The total amount of rounds they were a block verifier and online / the total amount of rounds they were a block verifier<br><br>[{"total_vote_count":"200000000","delegate_name":"delegate_name_5","shared_delegate_status":"false","delegate_fee":"0.100000","block_verifier_score":"0","online_status":"true","block_verifier_total_rounds":"5","block_verifier_online_percentage":"0"},{"total_vote_count":"100000000","delegate_name":"delegate_name_4","shared_delegate_status":"false","delegate_fee":"","block_verifier_score":"0","online_status":"true","block_verifier_total_rounds":"4","block_verifier_online_percentage":"25"},{"total_vote_count":"50000000","delegate_name":"delegate_name_3","shared_delegate_status":"false","delegate_fee":"","block_verifier_score":"0","online_status":"true","block_verifier_total_rounds":"3","block_verifier_online_percentage":"33"},{"total_vote_count":"20000000","delegate_name":"delegate_name_2","shared_delegate_status":"false","delegate_fee":"","block_verifier_score":"0","online_status":"true","block_verifier_total_rounds":"2","block_verifier_online_percentage":"100"},{"total_vote_count":"10000000","delegate_name":"delegate_name_1","shared_delegate_status":"false","delegate_fee":"","block_verifier_score":"0","online_status":"true","block_verifier_total_rounds":"1","block_verifier_online_percentage":"0"}]',
  showCloseButton: false,
  showCancelButton: false,
})
    }
...
else if (data === "shared_delegate_status")
{
Swal.fire({
  ...
  width: this.width,
  customClass: 'swal-height',
  html: data2.shared_delegate_status,
  showCloseButton: false,
  showCancelButton: false,
})
}
