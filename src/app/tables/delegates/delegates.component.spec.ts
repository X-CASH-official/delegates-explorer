...
describe('delegatesComponent', () => {
  ...
  it('should update delegates table', () => {
    ...
    expect(fixture.debugElement.nativeElement.querySelector('#shared_delegate_status1').textContent).toContain(test_data[0].shared_delegate_status);
    ...
    expect(fixture.debugElement.nativeElement.querySelector('#shared_delegate_status2').textContent).toContain(test_data[1].shared_delegate_status);
